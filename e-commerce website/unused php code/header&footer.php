...
<head>
    ...
    <link rel="stylesheet" href="style/header&footer-non-mini.css">
...
<body>
            <header>
                    <div id="logo-pic">
                       <a href="home-page.html"> <img src="images/logo-removebg-preview.png" alt="saiftech" id="logo" style="height: 100px;"> </a>
                    </div>
                 ...
                 <nav class="main-menu active11">
                     <div id="menu-items1">
                                ...
                                <form id="header-itmes">
                                <div id="search-bar">
                                <input type="searchbox" placeholder="type to search" id="search" size="40" > 
                                 </form>
                                    ...
                                    <div id="account">
                                        <a href="profile page.html" class="links">
                                            <b>account</b>
                                        </a>
                                    </div>
                                ...
                                <div class="login">
                                    <a href="login-page.html" class="links">
                                        <b>login</b>
                                    </a>
                                </div>
                                ...
                                <div class="register">
                                    <a href="register.html" class="links">
                                        <b>register</b>
                                    </a>
                                </div>
                            
                                <div id="cart">
                                    <a href="cart.html" class="links">
                                        <b>cart</b>
                                    </a>
                                </div>
                ...
                <div id="menu-items2">
                    ...
                    <div class="item-hf">
                        <a href="products page.html" class="links">
                            <b>components</b>
                        </a>
                    </div>

                    <div class="item-hf" id="acce">
                        <a href="products page.html" class="links">
                            <b>accessories</b>
                        </a>
                    </div>
           ...
           <footer>
                <div class="footer-info">
                    <div id="contact-us" class="footer-text">
                            <b>contact-us</b>
                    </div>
                    <ul>
                        <li>facebook</li>
                 ...
                 <div class="footer-info">
                    <div id="help-center" class="footer-text">
                            <b>help-center</b>
                    </div>
                    <ul>
                        <li>Phonenumber: 0790290514</li>
                    </ul>
                </div>

                <div class="footer-info">
                    <div id="about-us" class="footer-text">
                            <b>about-us</b>
                    </div>
